...
initialize();
    ...
    public void layoutForSimView()
    {
        ...
        /*((ViewableComponent)withName("processor_3")).setPreferredLocation(new Point(201, 103));
        ((ViewableComponent)withName("processor_5")).setPreferredLocation(new Point(-7, 20));
        ((ViewableComponent)withName("processor_6")).setPreferredLocation(new Point(187, 22));
        ((ViewableComponent)withName("processor_7")).setPreferredLocation(new Point(148, 179));
        ((ViewableComponent)withName("processor_8")).setPreferredLocation(new Point(-4, 105));
        ((ViewableComponent)withName("processor_9")).setPreferredLocation(new Point(187, 22));
        ((ViewableComponent)withName("processor_10")).setPreferredLocation(new Point(148, 179));
        ((ViewableComponent)withName("processor_11")).setPreferredLocation(new Point(-4, 105));
        ((ViewableComponent)withName("processor_12")).setPreferredLocation(new Point(201, 103));
        ((ViewableComponent)withName("processor_13")).setPreferredLocation(new Point(-7, 20));
        ((ViewableComponent)withName("processor_14")).setPreferredLocation(new Point(187, 22));
        ((ViewableComponent)withName("processor_15")).setPreferredLocation(new Point(148, 179));
        ((ViewableComponent)withName("processor_16")).setPreferredLocation(new Point(-4, 105));*/
